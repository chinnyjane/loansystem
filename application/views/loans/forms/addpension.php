<form class="form-horizontal formpost" id="formpost" method="post" action="<?php echo base_url();?>client/profile/<?php echo $clientid;?>/addpension">
    <div class="modal-content">
       ...
       <input type="submit" class="btn btn-sm btn-success submit"  name="submit"  value="Add Pension">
		</div>
	 </div>
	 </form>
