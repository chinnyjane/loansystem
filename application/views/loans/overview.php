		...
		<div class="panel panel-yellow">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge"><?php echo $this->loansetup->loancount('granted');?></div>
						<div>Loans Granted</div>
					</div>
				</div>
			</div>
			<a href="<?php echo base_url();?>loans/status/granted">
				<div class="panel-footer">
					<span class="pull-left">View Details</span>
					<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
					<div class="clearfix"></div>
...
<div class="row">
	<div class="col-lg-12">
		<?php
			$page['status'] = 'granted';
			$this->load->view('loans/consolidated', $page);
		?>
	</div>
</div>
