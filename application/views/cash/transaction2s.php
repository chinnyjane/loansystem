...
<script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
			var height = '450px';
            $("#collectee").freezeHeader({ 'height': height }); 
            $("#disbursee").freezeHeader({ 'height': height }); 
            $("#adjustee").freezeHeader({ 'height': height }); 
            $("#recapee").freezeHeader({ 'height': height}); 
 ...
 <ol class="breadcrumb">
  ...
  <li class="active">As of <?php echo date("F d, Y", strtotime($transdate));?></li>
  
</ol>
<div class="panel panel-primary"><div class="panel-heading"><b><?php echo $branch->branchname;?> </b></div>
