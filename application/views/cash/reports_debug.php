...
?>
	...
	<?php
		...
		$this->table->add_row(array("align"=>"right","data"=>'#', "width"=>"1%"), array("align"=>"left","data"=>'Bank Code', "width"=>"8%"), 'OR No','PN',array("colspan"=>'2','data'=>'Name'),'Type',array("align"=>"right","data"=>'Cash', "width"=>"8%"), array("align"=>"right","data"=>'Check', "width"=>"8%"), array("align"=>"right","data"=>'Online', "width"=>"8%"),array("align"=>"right","data"=>'POS', "width"=>"8%"), array("align"=>"right","data"=>'Collections', "width"=>"8%"));
			...
			if($banktrans->num_rows() >0){
				...
				foreach($banktrans->result() as $bt){
					...
					$this->table->add_row(array("align"=>"right","data"=>$count, "width"=>"1%"), array("align"=>"right","data"=>$bt->bankCode, "width"=>"8%"), $bt->referenceNo, $bt->PN, array("colspan"=>'2','data'=>$bt->Particulars), $bt->transType, array("align"=>"right","data"=>$cashin,"width"=>"8%"),array("align"=>"right","data"=>$checkin,"width"=>"8%"), array("align"=>"right","data"=>$onlinein,"width"=>"8%"),array("align"=>"right","data"=>$posin, "width"=>"8%"),array("align"=>"right","data"=>number_format($in,2), "width"=>"8%"));				
				...
				echo $this->table->add_row(array("colspan"=>"7","data"=>"TOTAL"), array("align"=>"right","data"=>$totalcash,"width"=>"8%"),array("align"=>"right","data"=>$totalcheck, "width"=>"8%"), array("align"=>"right","data"=>$totalonline,"width"=>"8%"), array("align"=>"right","data"=>$totalpos,"width"=>"8%"), array("align"=>"right","data"=>number_format($totalin,2),"width"=>"8%") );	
				//
	...
	<!-- TOTAL DISBURSEMENT -->	
			...
			$this->table->add_row('#', 'Bank Code', 'CV No','PN No', 'Check No',  'Particulars', 'Explanation',array("align"=>"right","data"=>'RFPL', "width"=>"8%"),array("align"=>"right","data"=>'Expenses', "width"=>"8%"), array("align"=>"right","data"=>'Releases', "width"=>"8%"), array("align"=>"right","data"=>'FT', "width"=>"8%"), array("align"=>"right","data"=>'Total', "width"=>"8%"));		
			if($banktrans->num_rows() >0){
				$count=1;
				$totalcoll = array();				
				$totalexp = 0;
		...
		$this->table->add_row(array("colspan"=>'12','data'=>'ADJUSTMENT'));
			...
			if($banktrans->num_rows() >0){
				...
				foreach($banktrans->result() as $bt){
					...
					echo $this->table->add_row($count, $bt->referenceNo, $bt->bankCode, array('colspan'=>'2','data'=>$bt->Particulars), array('colspan'=>'3','data'=>htmlspecialchars($bt->explanation, ENT_QUOTES )), array('colspan'=>'2','data'=>$bt->transType), array("align"=>"right","colspan"=>'2',"data"=>number_format($amount,2)));				
