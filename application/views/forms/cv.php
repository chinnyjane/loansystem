...
?>
    <div class="modal-content">
	  ...
	  <div class="col-xs-4 has-error"><label>CV No.</label>
		...
		<input type="text" name="PN" class="form-control input-sm" value = "<?php echo $bookpn;?>" required readonly >
		</div>
	  </div>
	  <div class="row form-group">
		<div class="col-xs-4"><label>Payee</label>
		<input type="text" name="particular" class="form-control input-sm"  value="<?php echo $payee;?>" required >
		</div>
