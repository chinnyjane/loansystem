...
class Daily extends CI_Controller {
	...
	function addtransaction(){
		...
		if($this->cash->addtransaction() != false)
		{
			$footer = validation_errors();
			$content = "Transaction was posted.";
			echo $content;
			//echo $this->form->modal($content, $footer);
			
		}else{
			echo validation_errors();
			$content = "Transaction was not posted. Please try again.";
			//echo $this->form->modal($content, $footer);
		}
	}
	...
	function trans(){
		...
		$cmcstatus = $_POST['status'];
		$trans = $_POST['trans'];
		 $tmpl = array ('table_open'          => '<table class="gridView table table-bordered table-condensed table-hover" id="coltable" >',
					'thead_open' => '<thead class="header">'	);
				$this->table->set_template($tmpl);
		switch($trans){
			case "collection":
				echo $this->cash->collectionByTransID($transid, $cmcstatus);
			break;
			
			case "disbursement":
				echo $this->cash->disbursementByTransID($transid, $cmcstatus);
			break;
			
			case "adjustment":
				echo $this->cash->adjustmentByTransID($transid, $cmcstatus);
			break;
		}
