...
class MY_Pagination extends CI_Pagination {
    ...
    public function __construct()
    {
		...
		$config_style['num_tag_open'] = '<li>';
        $config_style['num_tag_close'] = '</li>';
		$config_style['cur_tag_open'] = '<li class="active"><a href="#">';
        $config_style['cur_tag_close'] = '</a></li>';
		$config_style['next_link'] = 'Next &rarr;';
        $config_style['next_tag_open'] = '<li class="next">';
        $config_style['next_tag_close'] = '</li>';
        $config_style['prev_link'] = '&larr; Previous';
    ...
    function create_links()
    {
        ...
        {          
            ...
            else
            {
                ...
                $output .= $prev_tag_o.'<a href="'.( (isset($prev_disabled)) ? '#' : ($this->base_url.$i) ).'">'.$this->prev_link.'</a>'.$this->prev_tag_close;
            }
        ...
        if ($this->next_link !== FALSE)
        {
            ...
            $output .= $next_tag_o.'<a href="'.( (isset($next_disabled))? '#' : ($this->base_url.$this->prefix.$i.$this->suffix) ).'">'.$this->next_link.'</a>'.$this->next_tag_close;
        }
